...
struct Text {
     ...
     */
    Text(std::string content, std::shared_ptr<Font> font, glm::vec2 position, float scale = 1.0f, glm::vec3 colour = {1.0f, 1.0f, 1.0f}) noexcept;
     ...
     */
    Text(std::string content, const std::string& pathToTTF, glm::vec2 position, float scale = 1.0f, glm::vec3 colour = {1.0f, 1.0f, 1.0f}) noexcept;
